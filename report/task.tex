...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 1.2. Анализ программных средств разработки и выбор технологического стека                           & 7                  & 26.03.2026    &                     \\ \hline
    Задача 1.3. Формулировка цели, задач и требований проекта                                                    & 8                  & 30.03.2026    &                     \\ \hline
    ...
    Задача 3.1. Разработка базовой структуры приложения и шаблонов страниц                   & 8                  & 21.04.2026    &                     \\ \hline
    Задача 3.2. Реализация аутентификации и авторизации пользователей                                           & 7                  & 27.04.2026    &                     \\ \hline
    Задача 3.3. Реализация CRUD-интерфейса для управления пайплайнами и этапами выполнения         & 7                  & 03.05.2026    &                     \\ \hline
    Задача 3.4. Реализация системы запуска, мониторинга и отображения статусов CI/CD-пайплайнов                                           & 12                 & 09.05.2026    &                     \\ \hline
    Задача 3.5. Реализация системы логирования, хранения и обработки данных запусков                                                 & 6                  & 15.05.2026    &                     \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 4. Оформление итогов работы}}                                                                               \\ \hline
    Задача 4.1. Создание Git-репозитория с исходным кодом проекта                                             & 3                  & 22.03.2026    &                     \\ \hline
